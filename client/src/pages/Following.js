            ...
            <Box>
                ...
                <Grid container spacing={2} >
                    <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center' }}>
                        <FollowingList following={user.following} onUnfollowClick={onUnfollowClick} />
                    </Grid>
                    <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center' }}>
                        <FollowersList followers={user.followers} following={user.following} onFollowClick={onFollowClick} onUnfollowClick={onUnfollowClick} />
                    </Grid>
                </Grid>
            </Box>
        </Box>
